<?php
    ...
    // CTL_ADMIN
    define('ERROR_CHANGE_LEVEL', "Error al cambiar el nivel del usuario");
    ...
    define('DASHBOARD_POSTS_CARD_TITLE', 'Publicacions');
    define('DASHBOARD_POSTS_CARD_BODY', 'Publicacions Totals: ');
    define('DASHBOARD_POSTS_CARD_BUTTON', 'Veure publicacions');

    define('DASHBOARD_CATEGORIES_CARD_TITLE', 'Categories');
    define('DASHBOARD_CATEGORIES_CARD_BODY', 'Categories Existents: ');
    ...
    define('USERS_CARD_BODY_EDITORS_BUTTONS', 'Set Editor');
    ...
    define('POSTS_DETAILS_EDIT_TITLE', 'Editar post');
    define('POSTS_DETAILS_EDIT_NAME', 'Títol');
    define('POSTS_DETAILS_EDIT_CONTENT', 'Contingut');
    define('POSTS_DETAILS_EDIT_IMG', 'Imatge');
    define('POSTS_DETAILS_EDIT_CATEGORY', 'Categoria');
    ...
    define('REPORT_PANEL_CREATE_POST_CONTENT_PLACEHOLDER', 'Contingut de la publicacio');
    ...
    define('REPORT_PANEL_CREATE_POST_TAGS_PLACEHOLDER', 'Separar tags amb una coma');
    ...
    define('USER_PROFILE_LEVEL_-1', 'Banned');
    define('USER_PROFILE_LEVEL_-2', 'Pro');
    ...
    define('USER_PROFILE_EDIT_PROFILE_NAME', 'NICK');
    ...
    define('USER_PROFILE_EDIT_PROFILE_BIO_PLACEHOLDER', 'Biografia');
