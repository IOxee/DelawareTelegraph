			...
			if (isset($_SESSION['username'])) {
				...
				foreach ($posts as $post) {
					echo '<div class="container-fluid">';
						...
						echo '<div class="card mx-auto d-flex justify-content-center col-12" style="width: 18rem; flex">';
							echo '<img src="' . $post['header_image'] . '" class="card-img-top" alt="...">';
							echo '<div class="card-body">';
								...
								echo '<span class="badge bg-dark">' . $post['tags'] . '</span>';
								echo '<br/><br><a href="' . INDEX_URL . '?action=post&id=' . $post['id'] . '" class="btn btn-outline-dark">Ver más</a>';
							echo '</div>';
						echo '</div>';
					echo '</div>';
				}
